...
RadarMap.prototype = {
    ...
    drawMap:function(){
        var me = this,x = me.options.x,y = me.options.y,t = me.options.t;
        var marginLeft = me.options.marginLeft,marginTop = me.options.marginTop,radius = me.options.radius;
    ...
    scanThread:function(){
        var me = this,x = me.options.x,y = me.options.y,t = me.options.t,radius = me.options.radius;
        var ctx = me.options.ctx;
        if (t>160)
            t=0;
        //扫描动画
    ...
    drawPoint:function(){
        var me = this,points = me.options.points,ctx = me.options.ctx,palette = me.options.palette;
        var pr = 7;
...
RadarMap.prototype.UpdatePoints  = function(){
    var me = this;
    var points = me.options.points;
    points.forEach(element => {
